...
<page backtop="15mm" backbottom="15mm" backleft="10mm" backright="10mm" style="font-size: 13px; font-family: helvetica" >
	<page_footer>
        ...
        <tr style="vertical-align: top">
            ...
            <td style="width:20%;">
				...
				<p style="font-size:14pt;font-weight:bold">Número: <?php echo $purchase_order_id;?></p> 
	...
	<table style="width:100%;margin-top:5px">
		<tr>
			...
			<td style="width:45%;" class='fondo-sky'>ENVIADO POR</td>
		</tr>
		<tr>
	...
	<table style="width:100%;margin-top:10px" class='table'>
		<tr>
			...
			<td style="width:50%;" class='fondo-sky'>NOMBRE DEL REPARTIDOR</td>
		</tr>
		<tr>
	...
	<table style="width:100%;margin-top:10px" class='table'>
		...
		?>
				...
				<tr>
					<td style="width:50%: #337ab7;" class='text-center fondo-sky bottom left right' colspan='4' >RUTA DE ENVÍO</td>
					<td class='text-right'>IVA<?php (tax_txt);?> <?php echo $simbolo_moneda;?></td>
