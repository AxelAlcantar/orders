...
?>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control form-rounded" id="fullname" name="fullname" placeholder="Ingresa el nombre completo del usuario" value="<?php echo $fullname;?>" required>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control form-rounded" id="user_name" name="user_name" placeholder="Ingresa el usuario" value="<?php echo $user_name;?>" pattern="[a-zA-Z0-9]{4,64}" required>
		</div>
	  </div>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control form-rounded" id="user_email" name="user_email" placeholder="example@gmail.com" value="<?php echo $user_email;?>" required>
		</div>
	  </div>
