  ...
  <div class="modal-dialog" role="document">
    <div class="borde-redondeado">
      <div class="modal-header">
        ...
        <h4 class="modal-title fw-bolder">NUEVO USUARIO</h4>
      </div>
      ...
      <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control form-rounded" id="fullname" name="fullname" placeholder="Ingresa el nombre completo del usuario" required>
		</div>
	  </div>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control form-rounded" id="user_name" name="user_name" placeholder="Ingresa el usuario" pattern="[a-zA-Z0-9]{4,64}" required>
		</div>
	  </div>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control form-rounded" id="user_email" name="user_email" placeholder="example@gmail.com" required>
		</div>
	  </div>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
			<select class="form-control form-rounded" name="user_group_id" id="user_group_id">
				<?php
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="password" class="form-control form-rounded" id="user_password_new" name="user_password_new" placeholder="******" pattern=".{6,}" required>
		</div>
	  </div>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="password" class="form-control form-rounded" id="user_password_repeat" name="user_password_repeat" placeholder="******" pattern=".{6,}"  required>
		</div>
	  </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default form-rounded" data-dismiss="modal">Cerrar</button>
