  ...
  <div class="modal-dialog" role="document">
    <div class="borde-redondeado">
      <div class="modal-header">
        ...
        <h4 class="modal-title fw-bolder">NUEVA SUCURSAL</h4>
      </div>
      ...
      <div class="form-group">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control form-rounded" id="code" name="code" required>
		</div>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <textarea class='form-control form-rounded' name="address" id='address' required></textarea>
		</div>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <select name="user_id" id="user_id" class='form-control form-rounded' required>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <select name="status" id="status" class='form-control form-rounded' required>
