  ...
  <div class="modal-dialog" role="document">
    <div class="card-rounded">
      <div class="modal-header">
        ...
        <h4 class="modal-title fw-bolder">NUEVO ADMINISTRADOR</h4>
      </div>
      ...
      <div class="form-group  ">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control form-rounded" id="nombres" name="nombres" placeholder="Ingresa el nombre del nivel administrador" required>
		</div>
	  </div>
