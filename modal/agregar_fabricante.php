  ...
  <div class="modal-dialog" role="document">
    <div class="card-rounded">
      <div class="modal-header">
        ...
        <h4 class="modal-title fw-bolder">NUEVO FABRICANTE</h4>
      </div>
      ...
      <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control form-rounded" id="name" name="name" placeholder="Ingresa el fabricante" required>
		</div>
	  </div>
