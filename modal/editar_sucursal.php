  ...
  <div class="modal-dialog" role="document">
    <div class="card-rounded">
      <div class="modal-header">
        ...
        <h4 class="modal-title fw-bolder">EDITAR SUCURSAL</h4>
      </div>
      <div class="modal-body">
      <div class="form-group">
		<label for="code2" class="col-sm-4 control-label">Código de sucursal </label>
		<div class="col-sm-8">
		  <input type="text" class="form-control form-rounded" id="code2" name="code2" required>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control form-rounded" id="name2" name="name2" required>
		</div>
	  </div>
	  <div class="form-group">
		<label for="address2" class="col-sm-4 control-label">Dirección </label>
		<div class="col-sm-8">
		  <textarea class='form-control form-rounded' name="address2" id='address2' required></textarea>
		</div>
	  </div>
	  <div class="form-group">
		<label for="phone2" class="col-sm-4 control-label">Teléfono </label>
		<div class="col-sm-8">
		  <input type="text" class="form-control form-rounded" id="phone2" name="phone2" required>
		</div>
	  </div>
	  <div class="form-group">
		<label for="user_id2" class="col-sm-4 control-label">Contacto </label>
		<div class="col-sm-8">
		  <select name="user_id2" id="user_id2" class='form-control form-rounded' required>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <select name="status2" id="status2" class='form-control form-rounded' required>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default btn-rounded" data-dismiss="modal">Cerrar</button>
         <button type="submit" id="actualizar_datos" class="btn bg-buttons btn-rounded">Actualizar datos</button>
      </div>
    </div>
  </div>
</div>
