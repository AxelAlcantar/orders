...
<table class="table">
<tr>
	<th class='fw-bolder'>CODIGO</th>
	<th class='text-center fw-bolder'>CANT.</th>
	<th class='fw-bolder'>PAN</th>
	<th class='fw-bolder'>SUCURSAL</th>

	<th class="text-center fw-bolder" style="text-align:center;">PRECIO UNIT.</th>
	<th><span class="pull-right fw-bolder">PRECIO TOTAL</span></th>
</tr>
<?php
	$sumador_total=0;
	...
	$qty_rec=$row['qty_rec'];
		...
		<tr>
			...
			<td class='text-center'><?php echo $qty;?></p></td>
			<td><?php echo $product_name;?></td>
			<td><?php echo $nombre_sucursal;?></td>

			<td class="text-center" style="text-align:center;"><?php echo number_format($unit_price,$precision_moneda,$sepador_decimal_moneda,$sepador_millar_moneda);?></td>
...
<tr>
	<td colspan=6><span class="pull-right fw-bolder"><?php echo ucfirst(neto_txt);?> <?php echo $simbolo_moneda;?></span></td>
...
<tr>
	<td colspan=6><span class="pull-right fw-bolder">IVA<?php (tax_txt);?><?php echo " $simbolo_moneda";?></span></td>
...
<tr>
	<td colspan=6><span class="pull-right fw-bolder"><?php echo ucfirst(total_txt);?> <?php echo $simbolo_moneda;?></span></td>
