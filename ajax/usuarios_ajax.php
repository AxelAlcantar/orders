<?php
	...
	$query_validate1=mysqli_query($con,"SELECT user_group_id from user_group where user_group_id='".$user_id."'");
	$count1=mysqli_num_rows($query_validate1);
	$query_validate2=mysqli_query($con,"SELECT employee_id from purchases_order where employee_id='".$user_id."'");
	...
	<div class="row">
		<div class="col-md-12">
			<div class="borde-redondeado">
				...
				<h2 class="fw-bolder">USUARIOS</h2>
				</div><!-- /.box-header -->
				<div class="box-body">
