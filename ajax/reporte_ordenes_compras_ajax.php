...
if($action == 'ajax'){
	...
	$campos="*";
	$sWhere="users.user_id=purchases_order.employee_id and client_id>0";
	if ($employee_id>0){
	...
	<div class="row">
		<div class="col-md-12">
			<div class="borde-redondeado">
				...
				<h2 class="fw-bolder">REPORTES DE ÓRDENES</h2>
				</div><!-- /.box-header -->
				<div class="box-body">
				<div class="table-responsive">
					<table class="table table-condensed table-hover">
						...
						while($row = mysqli_fetch_array($query)){	
							...
							$sql_client=mysqli_query($con,"select name from clients where id='".$client_id."'");
