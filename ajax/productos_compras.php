			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					$production_price=$row["selling_price"];
					$stock=$row["stock"];
					$production_price=number_format($production_price,2,'.','');
					?>
					<tr>
						...
						<div class="input-group pull-right">
							...
							<input type="text" class="form-control" style="text-align:right" id="precio_venta_<?php echo $id_producto; ?>"  value="<?php echo $production_price;?>" >
						</div>
						</td>
