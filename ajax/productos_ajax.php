...
if($action == 'ajax'){
	...
	$campos="products.product_id, products.model, products.product_name, products.status, products.image_path, products. product_code, products.selling_price, products.stock, manufacturers.name, products.category_id";
