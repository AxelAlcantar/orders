<?php
	...
	list ($id_cliente, $fecha_creado,$nombre_cliente, $direccion_cliente, $ciudad_cliente, $estado_direccion, $codigo_postal_cliente,$codigo_ciudad_cliente, $telefono_cliente,$sitio_web_cliente, $tax_cliente) = get_data("clients",'id',$client_id); //datos del cliente
	
	list ($id_contacto,$id_cliente_contacto,$nombres_contacto, $apellidos_contacto, $email_contacto, $telefono_contacto)=get_data("contacts_clients","client_id",$client_id);//Datos del contacto
