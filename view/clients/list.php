...
<html>
  ...
  <body class="hold-transition <?php echo $skin;?> sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <!-- Content Wrapper. Contiene el contenido de la paguina -->
				...
				<div class="row">
					...
					<div class="col-xs-5 ">
						<div class="btn-group pull-right">
							...
							<button type="button" class="btn bg-buttons"  data-toggle="modal" data-target="#cliente_modal"><i class='fa fa-plus'></i> Agregar</button>
							<?php }?>
