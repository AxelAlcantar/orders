  ...
  <body class="hold-transition <?php echo $skin;?> sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
		  <h2 class="fw-bolder">PERFIL DE LA EMPRESA</h2>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="details">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control form-rounded" id="business_name" name="business_name"
					   placeholder="Nombre de la empresa" value="<?php echo $name;?>">
                    </div>
                  </div>
				  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control form-rounded" id="industry" name="industry"
					   placeholder="Actividad económica" value="<?php echo $industry;?>">
                    </div>
                  </div>
				  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control form-rounded" id="number_id" name="number_id"
					   placeholder="Número de registro" value="<?php echo $number_id;?>">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control form-rounded" id="phone" name="phone"
					   placeholder="Teléfono" value="<?php echo $phone;?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="tax" class="col-sm-3 control-label">IVA %</label>
                    <div class="col-sm-9">
						<input type="text" class="form-control form-rounded" id="tax" name="tax" 
						placeholder="Impuesto" value="<?php echo $tax;?>" maxlength=2>
                    </div>
                  </div>
				  <div class="form-group">
					...
					?>
						<select class='form-control form-rounded select2' name="currency" id="currency">
						<?php
							while ($rw_currencies=mysqli_fetch_array($query_currencies)){
								?>
								<option value="<?php echo $rw_currencies['id'];?>"
								 <?php if ($rw_currencies['id']==$currency_id){echo "selected";}else {echo "";}?>><?php echo $rw_currencies['name'];?></option>
								<?php 
							}
						?>
				  ...
				  <div class="form-group">
					...
					?>
						<select class='form-control form-rounded select2' name="timezone" id="timezone">
						<?php
							while ($rw_timezones=mysqli_fetch_array($query_timezones)){
								?>
								<option value="<?php echo $rw_timezones['id'];?>" 
								<?php if ($timezone_id==$rw_timezones['id']){echo "selected";}else {echo "";}?>><?php echo $rw_timezones['name'];?></option>
								<?php 
							}
						?>
				  ...
				  <div class="form-group">
					...
					?>
						<select class='form-control form-rounded' name="theme" id="theme">
						<?php
							while ($rw_sk=mysqli_fetch_array($query_skin)){
								?>
								<option value="<?php echo $rw_sk['id'];?>" 
								<?php if ($skin_id==$rw_sk['id']){echo "selected";}else {echo "";}?>><?php echo $rw_sk['name'];?></option>
								<?php 
							}
						?>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                      <button type="button" class="btn bg-buttons btn-rounded" onclick="return updateProfile();">Guardar datos</button>
                    </div>
                  </div>
              ...
              <!-- /.tab-pane -->
			   <div class="tab-pane" id="address">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control form-rounded" id="address1" name="address1"
					   placeholder="Calle" value="<?php echo $address;?>">
                    </div>
                  </div>
				  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control form-rounded" id="state" name="state"
					   placeholder="Región/Provincia" value="<?php echo $state;?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
					  ...
					  placeholder="Código Postal" value="<?php echo $postal_code;?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
						...
						<select class="form-control form-rounded select2" name="country_id" id="country_id" style='width:100%'>
							<?php
								while ($rw_countries=mysqli_fetch_array($query_countries)){
									?>
									<option value="<?php echo $rw_countries['id'];?>" 
									<?php if ($country_id==$rw_countries['id']){echo "selected";}else {echo "";}?>>
									<?php echo utf8_encode($rw_countries['name']);?></option>
									<?php 
								}
							?>
						</select>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                      <button type="button" class="btn bg-buttons btn-rounded" name="update" onclick="return updateProfile();">Guardar datos</button>
                    </div>
                  </div>
	...
	<script>
		...
		function updateProfile(){
			...
			"currency":currency, "timezone":timezone,"address1":address1,"city":city,"state":state,"postal_code":postal_code,
			"country_id":country_id,"industry":industry,"theme":theme };
			 $.ajax({
				type: "POST",
