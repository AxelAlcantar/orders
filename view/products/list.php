      ...
      <div class="content-wrapper">
		...
		<section class="content-header">
				...
				<div class="col-md-3 col-xs-3">
						<input type="text" class="form-control form-rounded" placeholder="Buscar por código" id='product_code' onkeyup="load(1);">
					</div>
                    <div class="col-xs-3">
						<div class="input-group">
						  <input type="text" class="form-control" placeholder="Buscar por nombre" id='q' onkeyup="load(1);">
						  <span class="input-group-btn">
							<button class="btn bg-buttons" type="button" onclick='load(1);'><i class='fa fa-search'></i></button>
						  </span>
						</div><!-- /input-group -->
					...
					<div class="col-xs-6">
						<div class="btn-group pull-right me-auto">
							<?php if ($permisos_editar==1){?>
								<a href="add_product.php" class="btn bg-buttons"><i class='fa fa-plus'></i> Agregar</a>
							<?php }?>
