<?php
	...
	if (isset($_GET['id'])){
		...
		$production_price=number_format($rw_product['production_price'],2,'.','');
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="details">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control form-rounded" id="product_code" name="product_code"  value="<?php echo $product_code;?>" required>
                    ...
                    <div class="col-sm-4">
						<select class="form-control form-rounded" name="model" id="model">
							...
							<option value="Dulce" <?php if ($model=="Dulce"){echo "selected";}?>>Dulce</option>
							<option value="Integral" <?php if ($model=="Integral"){echo "selected";}?>>Integral</option>
						</select>
                    </div>
                  </div>
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control form-rounded" id="product_name" name="product_name" value="<?php echo $product_name;?>" required>
                    </div>
					...
					<div class="col-sm-4">
						<select class="form-control form-rounded" name="presentation" id="presentation">
							<option value="" >Selecciona</option>
							<option value="Bolsa" <?php if ($presentation=="Bolsa"){echo "selected";}?>>Bolsa</option>
							<option value="Caja" <?php if ($presentation=="Caja"){echo "selected";}?>>Caja</option>
						</select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
						<textarea class="form-control form-rounded" name="note" id="note"><?php echo $note;?></textarea>
                    </div>
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-4">
						<div class="input-group">
						  ...
						  <input type="text" class="form-control" id="production_price" name="production_price" value="<?php echo $production_price;?>" required pattern="\d+(\.\d{2})?" title="precio con 2 decimales" onkeyup="precio_venta();">
						</div>
                    </div>
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control form-rounded" name="status" id="status">
						<option value="1" <?php if ($status==1){echo "selected";}?>>Disponible</option>
