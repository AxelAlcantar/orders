<?php
	...
	$insert=mysqli_query($con,"INSERT INTO purchases_order (purchase_order_id, created_at,employee_id,includes_tax,currency_id) 
	VALUES ('$purchase_order_id', '$created_at','$employee_id',0,'$currency_id');");
  ...
  <body class="hold-transition <?php echo $skin;?> sidebar-mini">
        ...
        <section class="content">
          ...
          <div class="borde-redondeado">
            <div class="box-header with-border">
              <h2 class="fw-bolder">NUEVA ORDEN DE COMPRA</h3>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card-rounded">
                                <div class="box-header box-header-background-light with-border">
                                    <h3 class="box-title fw-bolder">DETALLES DE LA ORDEN</h3>
                                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <label>Cliente</label>
                                        <select class="form-control form-rounded select2" name="client_id" >
									...
									<div class="col-md-2">
                                       ...
                                       <input type="text" class="form-control form-rounded datepicker" name="purchase_date"  value="<?php echo $purchase_order_id;?>" disabled="">
                                    </div>
									
									<div class="col-md-2">
										<label>Estado</label>
										<select class="form-control form-rounded" disabled onchange="actualizar_campos(this.value,2)">
									...
									<div class="col-md-2">
										<label>Incuye IVA<?php (tax_txt);?></label>
										<select name="is_taxeable" id="is_taxeable" class='form-control form-rounded' onchange="actualizar_campos(this.value,6);">
											<option value="1" <?php if ($_SESSION['includes_tax']==1){echo "selected";}?>>SÍ </option>
                                    ...
                                    <div class="col-md-4">
									<label>Condiciones de pago<?php (tax_txt);?></label>
										<select name="condiciones" id="condiciones" class='form-control form-rounded' onchange="actualizar_campos(this.value,3);">
                                    ...
                                    <div class="col-md-3">
                                       <label>Nombre del repartidor</label>
										<input type="text" class="form-control form-rounded" name="envio" onblur="actualizar_campos(this.value,4)" >
                                    </div>
									<div class="col-md-5">
										<label>Ruta de envío</label>
										<input type="text" class="form-control form-rounded" name="comentarios" onblur="actualizar_campos(this.value,5)" >
                                    </div>
                                ...
                                <div class="box-footer pull-right">
									<button type="button" class="btn bg-buttons" data-toggle="modal" data-target="#myModal"><i class='fa fa-plus'></i> Agregar productos</button>
									<button type="button" onclick="imprimir('<?php echo $purchase_order_id;?>')" class="btn btn-default" style="margin-right: 5px;">
									<i class="fa fa-print form-rounded"></i> Imprimir</button>
                                </div>
	...
	<script>
		function imprimir(purchase_order_id){
			VentanaCentrada('purchase-order-print-pdf.php?purchase_order_id='+purchase_order_id,
			'Orden de Compra','','1024','768','true');
		}
	</script>
