        ...
        <section class="content">
          ...
          <div class="borde-redondeado">
            <div class="box-header with-border">
              <h2 class="fw-bolder">EDITAR ORDEN DE COMPRA</h2>
                            ...
                            <div class="card-rounded">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <label>Cliente</label>
                                        <select class="form-control form-rounded select2" name="client_id" <?php echo $disabled;?>>
											<option value="<?php echo $client_id;?>"><?php echo $nombre_cliente;?></option>
									...
									<div class="col-md-2">
										<label>Estado</label>
										<select class="form-control form-rounded"  onchange="actualizar_campos(this.value,2)" <?php echo $disabled;?>>
									...
									<div class="col-md-2">
										...
										<select name="is_taxeable" id="is_taxeable" class='form-control form-rounded' onchange="actualizar_campos(this.value,6);" <?php echo $disabled;?>>
									...
									<label>Condiciones de pago<?php (tax_txt);?></label>
										<select name="condiciones" id="condiciones" class='form-control form-rounded' onchange="actualizar_campos(this.value,3);">
											...
											<option value="Efectivo" <?php if ($terms=="Efectivo"){echo "selected";}?>>Efectivo</option>
											<option value="Tarjeta de crédito/debito" <?php if ($terms=="Tarjeta de crédito/debito"){echo "selected";}?>>Tarjeta de crédito/debito</option>
										</select>
										
                                    </div>
                                    <div class="col-md-3">
                                       <label>Nombre del repartidor</label>
										<input type="text" class="form-control form-rounded" name="envio" onblur="actualizar_campos(this.value,4)" value="<?php echo $ship_via;?>" <?php echo $disabled;?>>
                                    </div>
									<div class="col-md-5">
										<label>Ruta de envío</label>
										<input type="text" class="form-control form-rounded" name="comentarios" onblur="actualizar_campos(this.value,5)" value="<?php echo $note;?>" <?php echo $disabled;?>>
                                    </div>
                                ...
                                <div class="box-footer pull-right">
									<?php 
										if($status!=3){
									?>
									<button type="button" class="btn bg-buttons btn-rounded" data-toggle="modal" data-target="#myModal"><i class='fa fa-plus'></i> Agregar productos</button>
										<?php }?>
										<?php if ($status==1){?>
